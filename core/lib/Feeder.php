...
class Feeder {
    ...
    // $index is the feed content key heading
    // $heading is the feed content heading array
    // $arr is the data fetched by the build
    // $params is the parameter the router passes
    // $key is the key in the parameter, is exists
    // $paramsData is the arry of params in the feeder description
    static function processFeed($index, $heading, $arr, $params, $routePath, &$cache_table): array {   //, $key, $paramsData): array {
        ...
        // echopre("processFeed result: " . print_r($result, 1));
        return $result;
    }
        ...
        foreach($paramsData as $index => $heading) {
            ...
            switch($heading['type']) {
                ...
                case 'feed':
                    ...
                    // echopre("results for processFeed: " . print_r($result, 1));
